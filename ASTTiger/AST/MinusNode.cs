...
namespace ASTTiger
{
    public class MinusNode : BinaryOperationNode
    {
        public MinusNode(LanguageNode left, LanguageNode right): base(left, right)
        {
        ...
        public override Type GenCode(ILGenerator ilGenerator, TypeBuilder parent, FieldBuilder IsBreakFields, List<FieldBuilder> level, Label endLabel)
        {
            ...
            ilGenerator.Emit(OpCodes.Sub);//resta l-r y lo pone en el tope de la pila

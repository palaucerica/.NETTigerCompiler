...
namespace ASTTiger
{
    public class GreaterThanEqualNode : RelationalNode
    {
        public GreaterThanEqualNode(LanguageNode left, LanguageNode right): base(left, right)
        {           
        }
        public override Type GenCode(ILGenerator ilGenerator, TypeBuilder parent, FieldBuilder IsBreakFields, List<FieldBuilder> level, Label endLabel)
        {
            ...
            ilGenerator.Emit(OpCodes.Bge, verd);
